...
descriptions = {
    "Install AIDE": "AIDE helps detect unauthorized file system changes.",
    "Build and Test AIDE Database": "Creates a baseline to detect system modifications.",
    "Configure AIDE to Verify the Audit Tools": "Monitors audit tools for tampering.",
    "Configure Periodic Execution of AIDE": "Ensures ongoing integrity checks.",
    "Package \"prelink\" Must not be Installed": "Prelink interferes with file integrity tools.",
    "Ensure /tmp Located On Separate Partition": "Limits damage if /tmp fills up."
    ...
    # GNOME3-related – removed due to headless environment
    ...
    if "Title" in header_texts and "Result" in header_texts:
        ...
        for row in table.find_all("tr")[1:]:  # Skip header row
            ...
            if len(cols) >= result_index:
                ...
                desc = descriptions.get(title, "No description available.")
